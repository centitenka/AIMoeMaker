...
if _bpy_available:
    ...
    from ui.quick_panel import QUICK_PANEL_CLASSES
...
def register():
    ...
    bpy.types.Scene.aimm_body_type = bpy.props.EnumProperty(
        name="体型", items=[("loli", "萝莉", ""), ("teen", "少女", ""), ("default", "默认", ""), ("adult", "成人", "")], default="default")
    ...
    bpy.types.Scene.aimm_hair_style = bpy.props.EnumProperty(
        name="发型", items=[("short", "短发", ""), ("long", "长发", ""), ("twintail", "双马尾", ""), ("ponytail", "马尾", ""), ("bob", "波波头", ""), ("hime_cut", "公主切", ""), ("braid", "辫子", ""), ("odango", "丸子头", "")], default="short")
    ...
    bpy.types.Scene.aimm_eye_shape = bpy.props.EnumProperty(
        name="眼型", items=[("round", "圆形", ""), ("almond", "杏仁", ""), ("cat", "猫眼", ""), ("droopy", "下垂", ""), ("tsurime", "吊眼", ""), ("tareme", "垂眼", "")], default="round")
    ...
    bpy.types.Scene.aimm_face_shape = bpy.props.EnumProperty(
        name="脸型", items=[("oval", "椭圆", ""), ("round", "圆形", ""), ("heart", "心形", ""), ("square", "方形", ""), ("diamond", "菱形", "")], default="oval")
